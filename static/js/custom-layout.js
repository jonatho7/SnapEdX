...
IDE_Morph.prototype.initializeSnapIDE = function(settings){
    var ide = this;
    if(settings[CONFIG_TYPE.VERTICAL_LAYOUT]){
        ide[CONFIG_TYPE.VERTICAL_LAYOUT]= true;
    }else{
        ide[CONFIG_TYPE.VERTICAL_LAYOUT]= false;
    }
    ide.customMode();
}
...
IDE_Morph.prototype.customMode = function(){ //later may customize projectButton, settingButton
    ...
    if(this[CONFIG_TYPE.VERTICAL_LAYOUT]){
